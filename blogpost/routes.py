...
from blogpost.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm, CommentForm
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request',
                  sender='alexnad425@gmail.com',recipients=[user.email])
...
def new_comment():
    form = CommentForm()
    if form.validate_on_submit():
        comment = Comment(content=form.content.data,user_id = current_user)
